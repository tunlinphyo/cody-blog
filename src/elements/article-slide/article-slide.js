...
export class ArticleSlide extends LitElement {
  ...
  render() {
    ...
    return html`
      <section class="slide-container" @article-slide-item-active=${(event) => this.handleActiveSlide(event)}>
      ...
      <button type="button" class="scroll-button" data-type="prev" ?disabled=${isFirstSlide} @click=${() => this.goToPrev()}>
        <svg viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
          ...
          <line x1="10" y1="${isFirstSlide ? 12 : 4}" x2="2" y2="12" stroke="currentColor" stroke-width="1.4" />
          <line x1="10" y1="${isFirstSlide ? 12 : 20}" x2="2" y2="12" stroke="currentColor" stroke-width="1.4" />
        </svg>
      ...
      <button type="button" class="scroll-button" data-type="next" ?disabled=${isLastSlide} @click=${() => this.goToNext()}>
        <svg viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
          <line x1="2" y1="12" x2="22" y2="12" stroke="currentColor" stroke-width="1.4" />
          <line x1="14" y1="${isLastSlide ? 12 : 4}" x2="22" y2="12" stroke="currentColor" stroke-width="1.4" />
          <line x1="14" y1="${isLastSlide ? 12 : 20}" x2="22" y2="12" stroke="currentColor" stroke-width="1.4" />
        </svg>
