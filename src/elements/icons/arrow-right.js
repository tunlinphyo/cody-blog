    ...
    return svg`
      <svg viewBox="0 0 24 24" width=${this.size} height=${this.size}>
        <g stroke="currentColor" stroke-width="1.8">
          ...
          <line x1="13" y1="6" x2="22" y2="12" part="arrow-top" stroke-width="1.8" style="transform: translateX(var(--arrow-top-offset, 0));" />
          <line x1="13" y1="18" x2="22" y2="12" part="arrow-top" stroke-width="1.8" style="transform: translateX(var(--arrow-top-offset, 0));" />
        </g>
      </svg>
    `
  }
